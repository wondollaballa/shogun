...
export default class EditableTheExperienceModal extends Vue {
    ...
    private apply() {
        this.$root.$emit('apply-theexperience-data', this.imageUrl, this.imageRotateClass, this.content);
        this.$root.$emit('editable-nav-theexperience', {
            image: this.imageUrl,
