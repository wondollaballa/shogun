<template>
    <nav>
        ...
        <a class="nav-items center middle" :class="(pointReached === 'contact-us') ? 'active' : '' " @click="scrollToElement('contact-us')">contact us</a>
    </div>
    </nav>
</template>
<script lang="ts" src="./shogun_nav.ts"></script>