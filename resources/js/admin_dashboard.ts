...
Vue.component('image-modal', require('./components/admin/ImageModal.vue'));
...
Vue.component('items-modal', require('./components/admin/ItemsModal.vue'));
Vue.component('menu-edit', require('./components/admin/MenuEdit.vue'));
